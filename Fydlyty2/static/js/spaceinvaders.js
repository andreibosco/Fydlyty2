...
WelcomeState.prototype.enter = function(game) {
    ...
    game.sounds.init();
    game.sounds.loadSound('shoot', '/static/sounds/shoot.wav');
    game.sounds.loadSound('bang', '/static/sounds/bang.wav');
    game.sounds.loadSound('explosion', '/static/sounds/explosion.wav');
};
...
WelcomeState.prototype.draw = function(game, dt, ctx) {
    ...
    ctx.fillText("404! You are lost", game.width / 2, game.height/2 - 40);
    ctx.font="16px Arial";

    ctx.fillText("Press 'Space' to start playing Space Invaders.", game.width / 2, game.height/2);
};
